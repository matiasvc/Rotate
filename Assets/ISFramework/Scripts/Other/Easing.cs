...
public static class Easing {
	...
	public static float easing(EasingType easingType, float start, float end, float value)
	{
		switch (easingType)
		{
		...
		default:
			Debug.LogWarning("Warning! Unknow easy type: " + easingType.ToString());
			return 0;
		}
	}
